...
# Import the new visual generation function from the updated Stage 3
from stages.stage_3_media_engine import generate_visual_for_scene, get_audio_for_scene
...
def run_pipeline():
    ...
    print("\n✅ Stage 2 Complete.\n" + "-"*50)
      ...
      # 3. Print both the original idea and the final script
    print("\n" + "="*50)
    ...
    #     # Audio generation is unchanged
    #     get_audio_for_scene(scene["narration"], i) 
